...
function ship.update(dt)
  local dx = (ship.dx - ship.x) * 0.05
  local dy = (ship.dy - ship.y) * 0.05
...
function ship.draw()
  love.graphics.draw(exhaust, ship.x - 17, ship.y + 25) -- left
  love.graphics.draw(exhaust, ship.x + 17, ship.y + 25) -- right
